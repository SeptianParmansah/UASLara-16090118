                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <h3>{{$penghargaan->nama_penghargaan}}</h3>

                      <ul class="list-unstyled user_data">
                        <li><i class="fa fa-university user-profile-icon"></i> {{$penghargaan->keterangan}}</li>
                      </ul>

                      <a href="/penghargaan/{{$penghargaan->id}}/edit" class="btn btn-warning"><i class="fa fa-edit m-right-xs"> </i>Edit Profile</a>
                      <br>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Aktivitas Terakhir</a>
                          </li>
                        </ul>
